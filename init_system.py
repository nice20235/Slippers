...
SAMPLE_SLIPPERS = [
    {
        "image": "https://example.com/slippers/men1.jpg",
        "name": "Men Classic Slipper",
        "size": "42",
        "price": 19.99,
        "quantity": 25,
        "category_name": "Men",
    ...
    {
        "image": "https://example.com/slippers/women1.jpg",
        "name": "Women Cozy Slipper",
        "size": "38",
        "price": 21.99,
        "quantity": 30,
        "category_name": "Women",
    ...
    {
        "image": "https://example.com/slippers/kids1.jpg",
        "name": "Kids Fun Slipper",
        "size": "30",
        "price": 14.99,
        "quantity": 40,
        "category_name": "Kids",
...
async def create_sample_slippers(db: AsyncSession, categories):
    ...
    for slip_data in SAMPLE_SLIPPERS:
        ...
        if category:
            ...
            print(
                f"  ✅ Created slipper: {db_slipper.name} (${db_slipper.price}) size {db_slipper.size}"
            )
        else:
            print(
                f"  ⚠️  Category '{category_name}' not found for slipper: {slip_data['name']}"
            )
